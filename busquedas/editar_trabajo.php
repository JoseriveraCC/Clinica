...
<body>
    ...
    <input type="hidden" name="trabajo" value="<?= $trabajo['trabajo'] ?>">

    <label for="nombre">Nombre:</label>
    <input type="text" name="nombre" id="nombre" value="<?= $trabajo['nombre'] ?>" required>

    <input type="submit" value="Editar Trabajo">
    <a href="buscar_trabajo.php" class="btn-volver">Regresar</a>
</form>
</body>
</html>
